...
> = {
  es: {
    ...
    hint: 'Escribe el mensaje y envíalo desde esta sección. Un envío → e-mail (texto completo), push (título + resumen) y WhatsApp Utility cuando esté configurado.',
    subject: 'Asunto',
    ...
    utilityNote: 'WhatsApp aún no está configurado en el servidor (falta token Meta). Por ahora usa e-mail. Push web ya está activo.',
    preview: 'Ver alcance',
    ...
    resendHint:
      'Envía de nuevo el e-mail con el diseño corporativo a participantes aprobados que aún no firmaron el convenio.',
  ...
  'pt-BR': {
    ...
    hint: 'Escreva a mensagem e envie desta seção. Um envio → e-mail (texto completo), push (título + resumo) e WhatsApp Utility quando estiver configurado.',
    subject: 'Assunto',
    ...
    chPush: 'Push web',
    chWhatsApp: 'WhatsApp Utility',
    utilityNote: 'WhatsApp ainda não está configurado no servidor (falta token Meta). Por enquanto use e-mail. Push web já está ativo.',
    preview: 'Ver alcance',
    ...
    resendHint:
      'Reenvia o e-mail com o layout corporativo para aprovados que ainda não assinaram o convênio.',
  ...
  en: {
    ...
    hint: 'Compose the message and send from this section. One send → email (full text), push (title + summary) and WhatsApp Utility when configured.',
    subject: 'Subject',
    ...
    chPush: 'Web push',
    chWhatsApp: 'WhatsApp Utility',
    utilityNote: 'WhatsApp is not configured on the server yet (Meta token missing). Use email for now. Web push is already active.',
    ...
    resendHint:
      'Resend the corporate-designed email to approved participants who have not signed the agreement yet.',
