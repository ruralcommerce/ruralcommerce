...
> = {
  es: {
    ...
    profileItems: [
      ...
      { href: '/projeto/inversiones', label: 'Mis compras', page: 'inversiones' },
  ...
  'pt-BR': {
    ...
    profileItems: [
      ...
      { href: '/projeto/diagnostico', label: 'Diagnóstico', page: 'diagnostico' },
      { href: '/projeto/inversiones', label: 'Minhas compras', page: 'inversiones' },
  ...
  en: {
    ...
    profileItems: [
      ...
      { href: '/projeto/inversiones', label: 'My purchases', page: 'inversiones' },
    ...
    <header className={`projeto-site-header${variant === 'bar' ? ' projeto-site-header--bar' : ''}`}>
      <div className="projeto-site-header-inner">
        <div className="projeto-site-header-brands">
          <Link href={homeHref} aria-label={t.homeAriaLabel} className="projeto-site-header-rc-link">
            <Image
