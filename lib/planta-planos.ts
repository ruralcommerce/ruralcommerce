...
export const planoChrome: LocaleCopy<{
  ...
  es: {
    ...
    isoLead: '',
    iso3dTitle: 'Vista 3D',
    iso3dLead: 'Gira el galpón. Deshidratar / Triturar / Cocinar atenúa las otras técnicas sin ocultarlas.',
  ...
  'pt-BR': {
    ...
    isoLead: '',
    iso3dTitle: 'Vista 3D',
    iso3dLead: 'Gire o galpão. Desidratar / Triturar / Cozinhar atenua as outras técnicas sem escondê-las.',
  ...
  en: {
    ...
    isoLead: '',
    iso3dTitle: '3D view',
    iso3dLead: 'Orbit the shed. Dry / Mill / Cook dims the other techniques without hiding them.',
