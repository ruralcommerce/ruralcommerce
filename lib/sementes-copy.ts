...
const pt: Copy = {
  ...
  problemTitle: 'Qual problema tu queres resolver?',
  problemHint: 'Algo real do teu lugar. Que as pessoas pagariam para ver resolvido.',
...
const es: Copy = {
  ...
  servico: 'Servicio',
  servicoHint: 'Consulta, visita, know-how.',
  problemTitle: '¿Qué problema quieres resolver?',
  problemHint: 'Algo real de tu lugar. Que la gente pagaría por ver resuelto.',
...
const en: Copy = {
  ...
  problemTitle: 'What problem do you want to solve?',
  problemHint: 'Something real around you. That people would pay to see fixed.',
